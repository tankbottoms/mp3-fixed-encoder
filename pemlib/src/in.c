/*
 * in.c - Audio input handling (WAV file reading)
 *
 ...
 *
 * This file handles WAV file input parsing. It reads RIFF/WAVE headers
 * and extracts 16-bit stereo 44.1 kHz PCM audio data.
 *
 * Note: This file is not used by the embedded PEM encoder, which receives
 * audio data directly from hardware. It is provided for desktop testing.
 *
