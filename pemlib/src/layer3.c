/*
 * layer3.c - Legacy embedded encoder interface
 *
 ...
 *
 * This file contains the original embedded encoder interface used on
 * eCos-based portable media players. It provides L3_open(), L3_close(),
 * and L3_compressFrame() functions for frame-by-frame encoding.
 *
 * Note: This file is not used by the modern pem_encode CLI application,
 * which uses codec.c instead. It is preserved for reference and for
 * potential embedded ports.
 *
