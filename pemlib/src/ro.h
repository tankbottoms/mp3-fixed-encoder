/*
 * ro.h - ROM-resident read-only data structures
 *
 ...
 *
 * Declares the ro_sram structure containing all pre-computed constant
 * tables used by the encoder. On embedded systems, this structure is
 * placed in ROM to minimize RAM usage.
 *
