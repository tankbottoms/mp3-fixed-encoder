/*
 * main.c - Legacy Windows command-line interface
 *
 ...
 *
 * This file contains a Windows-specific command-line encoder.
 * It is not used on modern platforms (see src/main.c for the current CLI).
 *
