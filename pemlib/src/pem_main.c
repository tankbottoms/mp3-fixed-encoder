/*
 * pem_main.c - Legacy command-line interface
 *
 ...
 *
 * This file contains the original stdin-based command-line interface.
 * It is not used by the modern pem_encode application (see src/main.c).
 *
